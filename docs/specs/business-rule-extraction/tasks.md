...
- [x] 7. フロントエンド entities/business-rule の実装
  - [x] 7.1 BusinessRule型定義を実装する
    - `client/app/entities/business-rule/model.ts` を作成
    - RuleType型、SourceLocation型、BusinessRule型を定義
    - _Requirements: 4.1, 4.2_
  - [x] 7.2 BusinessRule APIクライアントを実装する
...
- [x] 8. フロントエンド widgets/rule-table の実装
  - [x] 8.1 RuleTypeBadgeコンポーネントを実装する
...
- [x] 9. フロントエンド pages/analysis への統合
  - [x] 9.1 解析結果ページに業務ルールタブを追加する
