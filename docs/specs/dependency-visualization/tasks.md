...
- [ ] 1. ドメイン層の実装
  - [ ] 1.1 DependencyEdgeエンティティとDependencyType列挙型を実装する
...
- [ ] 2. インフラストラクチャ層の実装
  ...
  - [ ] 2.2 Alembicマイグレーションを作成する
    ...
    - _Requirements: 1.1_
  - [ ] 2.3 SQLAlchemyDependencyEdgeRepositoryを実装する
...
- [ ] 4. アプリケーション層の実装
  - [ ] 4.1 GetDependencyGraphUseCaseを実装する
  ...
  - [ ] 4.5 GetSourceFilesForJobUseCaseを実装する
...
- [ ] 8. フロントエンド widgets/flow-graph の実装
  - [ ] 8.1 React Flow変換ロジックを実装する
  ...
  - [ ] 8.7 index.tsでエクスポートする
    - `client/app/widgets/flow-graph/index.ts` を作成

- [ ] 9. フロントエンド pages/dependencies の実装
  - [ ] 9.1 依存関係ページを実装する
